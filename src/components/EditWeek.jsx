...
function EditWeek() {
  ...
  async function confirmarGuardar() {
    ...
    try {
      ...
      console.log("TAREAS GUARDADAS:", respuestaTareas.data);
    } catch (error) {
      ...
      <div className="activities-page">
          ...
          <div className="modal-overlay">
            <div className="delete-modal">
              ...
              <p>
                ...
                {dias[tareaABorrar.indiceDia].tareas[
                  tareaABorrar.indiceTarea
              ...
              <div className="modal-actions">
                <button className="cancel-button" onClick={cancelarBorrado}>
                  Cancelar
                </button>

                <button className="delete-button" onClick={borrarTarea}>
                  Aceptar
                </button>
              </div>
            </div>
        ...
        {mostrarModalCancelar && (
          <div className="modal-overlay">
            <div className="delete-modal">
              <p>
                ¿Estás seguro de que quieres cancelar? Se perderán los datos
                introducidos.
              </p>

              <div className="modal-actions">
                <button className="delete-button" onClick={confirmarCancelar}>
                  Aceptar
                </button>

                <button className="cancel-button" onClick={cerrarModalCancelar}>
                  Cancelar
                </button>
              </div>
            </div>
        ...
        {mostrarModalGuardar && (
          <div className="modal-overlay">
            <div className="delete-modal">
              <p>¿Estás seguro de que quieres guardar la semana?</p>

              <div className="modal-actions">
                <button className="delete-button" onClick={confirmarGuardar}>
                  Aceptar
                </button>

                <button className="cancel-button" onClick={cerrarModalGuardar}>
                  Cancelar
                </button>
              </div>
            </div>
        ...
        {mostrarModalFinalizar && (
          <div className="modal-overlay">
            <div className="delete-modal">
              ...
              <div className="modal-actions">
                <button className="delete-button" onClick={confirmarFinalizar}>
                  Aceptar
                </button>
